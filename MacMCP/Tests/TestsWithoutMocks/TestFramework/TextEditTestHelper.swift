// ABOUTME: This file provides a helper class for testing TextEdit interactions.
// ABOUTME: It encapsulates common TextEdit test operations and state management.
...
final class TextEditTestHelper {
    ...
    init() {
        // Create a tool chain
        self.toolChain = ToolChain(logLabel: "mcp.test.textedit")
        
        // Create a TextEdit model
        self.app = TextEditModel(toolChain: toolChain)
