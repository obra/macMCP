...
@Suite(.serialized)
struct ApplicationsResourceE2ETests {
    // Test components
    ...
    @Test("Test applications resource lists running apps")
    ...
    mutating func testResourceRegistryWithRealHandlers() async throws {
        ...
        let windowsHandler = ApplicationWindowsResourceHandler(accessibilityService: accessibilityService, logger: logger)
