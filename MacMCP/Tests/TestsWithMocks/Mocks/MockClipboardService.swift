// ABOUTME: Provides a mock implementation of ClipboardServiceProtocol for testing
// ABOUTME: Tracks method calls and returns predetermined responses
...
public actor MockClipboardService: ClipboardServiceProtocol {
    ...
    private var _infoToReturn: ClipboardContentInfo = ClipboardContentInfo(
    ...
    public func clearClipboard() async throws {
        ...
        if _shouldThrowOnClear {
            throw createClipboardError(code: "TEST_ERROR", message: "Mock error clearing clipboard").asMCPError
        }
    }
    ...
    public func getClipboardInfo() async throws -> ClipboardContentInfo {
        ...
        if _shouldThrowOnGetInfo {
            throw createClipboardError(code: "TEST_ERROR", message: "Mock error getting clipboard info").asMCPError
        }
