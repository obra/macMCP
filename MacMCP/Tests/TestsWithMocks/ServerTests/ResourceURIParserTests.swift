...
@Suite(.serialized)
struct ResourceURIParserTests {
    
    @Test("Test parsing simple URI with scheme")
    func testParseSimpleURIWithScheme() throws {
        ...
        #expect(components.pathComponents == ["applications"], "Path components should be ['applications']")
    }
    ...
    func testParseURIWithPathComponentsAndScheme() throws {
        ...
        #expect(components.scheme == "macos", "Scheme should be 'macos'")
        #expect(components.path == "/applications/com.apple.TextEdit/windows", "Path should be '/applications/com.apple.TextEdit/windows'")
        #expect(components.queryParameters.isEmpty, "Query parameters should be empty")
        #expect(components.pathComponents == ["applications", "com.apple.TextEdit", "windows"], 
               "Path components should be ['applications', 'com.apple.TextEdit', 'windows']")
    }
    
    @Test("Test parsing URI without scheme")
    func testParseURIWithoutScheme() throws {
    ...
    @Test("Test parsing URI with query parameters")
    func testParseURIWithQueryParameters() throws {
        ...
        #expect(components.queryParameters["includeMinimized"] == "true", "includeMinimized should be 'true'")
        #expect(components.queryParameters["maxDepth"] == "3", "maxDepth should be '3'")
    }
    
    @Test("Test parsing URI with leading slash")
    func testParseURIWithLeadingSlash() throws {
        let uri = "macos:///applications/com.apple.TextEdit/windows"
        let components = try ResourceURIParser.parse(uri)
    ...
    @Test("Test extracting parameters from URI with pattern")
    func testExtractParameters() throws {
    ...
    @Test("Test formatting URI from path and query parameters")
    func testFormatURI() {
