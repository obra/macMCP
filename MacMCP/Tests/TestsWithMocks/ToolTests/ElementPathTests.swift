...
struct ElementPathTests {
    ...
    final class MockAccessibilityService: AccessibilityServiceProtocol, @unchecked Sendable {
        ...
        func getFocusedApplicationUIElement(recursive: Bool, maxDepth: Int) async throws -> UIElement {
            return UIElement(path: "ui://AXApplication[@AXTitle=\"Focused App\"][@bundleIdentifier=\"mock-focused-app\"]", role: "AXApplication", frame: CGRect.zero, axElement: nil)
        }
        ...
        func findElementByPath(_ pathString: String) async throws -> UIElement? {
            return UIElement(path: "ui://AXElement[@identifier=\"mock-path-element\"]", role: "AXElement", frame: CGRect.zero, axElement: nil)
        }
    ...
    func testAttributeMatching() throws {
