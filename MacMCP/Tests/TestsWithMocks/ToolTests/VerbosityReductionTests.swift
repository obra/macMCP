...
@Suite("Verbosity Reduction Tests")
struct VerbosityReductionTests {
  ...
  @Test("UIElement getStateArray shows exceptional states")
  func testStateArrayExceptionalStates() async throws {
  ...
  func testNameDeduplicationWithIdentifier() async throws {
    ...
    #expect(!jsonString.contains("\"name\""), "Name field should be omitted when it matches identifier")
  ...
  func testNameIncludedWhenUnique() async throws {
    ...
    #expect(jsonString.contains("\"name\":\"Click Me\""), "Name field should be included when unique")
    #expect(jsonString.contains("\"role\":\"AXButton\""), "Role should be present")
  ...
  func testTokenReduction() async throws {
    ...
    #expect(jsonString.count < 400, "JSON output should be significantly reduced: \(jsonString.count) chars")
