...
@Suite("MenuHierarchy Tests", .serialized) struct MenuHierarchyTests {
  @Test("MenuHierarchy initializes correctly") func testInitialization() async throws {
  ...
  @Test("MenuHierarchy cache expiration works correctly") func testCacheExpiration() async throws {
  ...
  @Test("MenuHierarchy serialization works correctly") func testSerialization() async throws {
  ...
  @Test("MenuHierarchy handles empty menus") func testEmptyMenus() async throws {
    let hierarchy = MenuHierarchy(
  ...
  @Test("MenuHierarchy handles special characters in menu names") func testSpecialCharacters()
    async throws
  {
    let menus = [
  ...
  @Test("MenuHierarchy handles unicode characters") func testUnicodeCharacters() async throws {
  ...
  @Test("MenuHierarchy cache validation dates") func testCacheValidationDates() async throws {
    let now = Date()
    let menus = ["File": ["File > New"]]
    let hierarchy = MenuHierarchy(
      application: "com.test.app",
