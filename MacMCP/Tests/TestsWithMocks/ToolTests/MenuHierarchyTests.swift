...
@Suite("MenuHierarchy Tests", .serialized)
struct MenuHierarchyTests {
    
    @Test("MenuHierarchy initializes correctly")
    ...
    @Test("MenuHierarchy cache expiration works correctly")
    ...
    @Test("allPaths returns flattened paths array")
    ...
    @Test("topLevelMenus returns sorted menu names")
    func testTopLevelMenus() async throws {
        let menus = [
            "View": ["View > Zoom In"],
            "File": ["File > New"],
            "Edit": ["Edit > Copy"],
    ...
    @Test("MenuHierarchy serialization works correctly")
    ...
    @Test("MenuHierarchy handles empty menus")
    func testEmptyMenus() async throws {
        let hierarchy = MenuHierarchy(
            application: "com.test.app",
            menus: [:],
            totalItems: 0,
    ...
    @Test("MenuHierarchy handles special characters in menu names")
    func testSpecialCharacters() async throws {
        let menus = [
            "File & Documents": ["File & Documents > New Document"],
    ...
    @Test("MenuHierarchy handles unicode characters")
    ...
    @Test("MenuHierarchy cache validation dates")
    func testCacheValidationDates() async throws {
        let now = Date()
        let menus = ["File": ["File > New"]]
