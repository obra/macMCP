// ABOUTME: Tests for path generation and display in the accessibility inspector
// ABOUTME: Verifies that element paths are correctly generated and filtered
...
final class ElementPathInspectorTests: XCTestCase {
    ...
    func testPathWithOptionalAttributes() throws {
        ...
        XCTAssertTrue(pathWithValue.contains("value=\"Hello world\""), "Path should include value attribute when requested")
    ...
    func testElementPathHierarchy() throws {
        ...
        XCTAssertLessThan(groupIndex!, buttonIndex!, "Parent role should appear before child role in path")
    }
}