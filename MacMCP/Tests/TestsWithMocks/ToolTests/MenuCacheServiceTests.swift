...
@Suite("MenuCacheService Tests", .serialized)
struct MenuCacheServiceTests {
    
    @Test("MenuCacheService stores and retrieves hierarchies")
    ...
    @Test("MenuCacheService returns nil for non-existent entries")
    ...
    @Test("MenuCacheService respects TTL expiration")
    ...
    @Test("MenuCacheService tracks hit and miss statistics")
    ...
    @Test("MenuCacheService invalidates specific entries")
    func testInvalidateSpecific() async throws {
        let cache = MenuCacheService()
    ...
    @Test("MenuCacheService invalidates all entries")
    ...
    @Test("MenuCacheService performs cleanup of expired entries")
    ...
    @Test("MenuCacheService enforces maximum cache size with LRU")
    ...
    @Test("MenuCacheService updates LRU order on access")
    func testLRUOrderUpdate() async throws {
    ...
    @Test("MenuCacheService provides detailed cache info")
