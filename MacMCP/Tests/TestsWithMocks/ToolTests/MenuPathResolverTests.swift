...
@Suite("MenuPathResolver Tests", .serialized) struct MenuPathResolverTests {
  @Test("buildPath creates correct path from components") func testBuildPath() async throws {
  ...
  private func createTestHierarchy() -> MenuHierarchy {
    let menus: [String: [String]] = [
      "File": [
        "File > New", "File > Open...", "File > Save", "File > Save As...", "File > Export > PDF",
        "File > Export > Web Page",
      ], "Edit": ["Edit > Undo", "Edit > Redo", "Edit > Cut", "Edit > Copy", "Edit > Paste"],
      "Format": [
        "Format > Font > Bold", "Format > Font > Italic", "Format > Text > Align Left",
