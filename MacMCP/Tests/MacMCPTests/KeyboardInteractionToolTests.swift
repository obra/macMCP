// ABOUTME: This file contains tests for the Keyboard Interaction Tool.
// ABOUTME: It verifies correct keyboard event generation and application interaction.
...
final class KeyboardInteractionToolTests: XCTestCase {
    ...
    func testTypeText() async throws {
        ...
        XCTAssertEqual(interactionStub.keyPressCount, text.count, "Should have pressed one key for each character")
    }
    ...
    func testTypeTextSpecialCharacters() async throws {
        ...
        XCTAssertTrue(interactionStub.usedModifiers, "Should have used modifiers for special characters")
    }
