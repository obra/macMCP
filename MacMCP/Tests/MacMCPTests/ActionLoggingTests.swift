...
struct ActionLoggingTests {
    ...
    func testLogFilteringByCategory() async throws {
        // Create a log capture service
        let logService = LogService()
        ...
        logService.addLogEntry(ActionLogEntry(
            timestamp: Date(),
            category: "interaction",
            action: "click",
            targetId: "button-123",
    ...
    func testLogFilteringByAction() async throws {
        // Create a log capture service
        let logService = LogService()
    ...
    func testLogFilteringByTimeRange() async throws {
        // Create a log capture service
        let logService = LogService()
