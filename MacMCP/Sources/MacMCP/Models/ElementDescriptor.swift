// ABOUTME: This file defines descriptor models for UI elements used by MCP tools.
// ABOUTME: These models provide standardized representations of various UI elements.
