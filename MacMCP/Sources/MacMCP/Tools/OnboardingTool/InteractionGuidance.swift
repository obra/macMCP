...
public enum InteractionGuidance {
  ...
  public static func guidance(specific: String?) -> String {
    switch specific {
      case "clicking": clickingGuidance
      case "typing": typingGuidance
      case "dragging": draggingGuidance
      case "scrolling": scrollingGuidance
      default: generalInteractionGuidance
    }
  }
