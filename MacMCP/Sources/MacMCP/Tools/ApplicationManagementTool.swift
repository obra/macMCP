// ABOUTME: This file implements the ApplicationManagementTool for managing macOS applications.
// ABOUTME: It provides functionality to launch, terminate, and control applications.
...
public struct ApplicationManagementTool: @unchecked Sendable {
    ...
    public var handler: @Sendable ([String: Value]?) async throws -> [Tool.Content] {
        return { [applicationService, logger] params in
            ...
            switch action {
            case .launch:
                return try await ApplicationManagementTool.handleLaunch(params, applicationService: applicationService, logger: logger)

            case .terminate:
                return try await ApplicationManagementTool.handleTerminate(params, applicationService: applicationService, logger: logger)

            case .forceTerminate:
                return try await ApplicationManagementTool.handleForceTerminate(params, applicationService: applicationService, logger: logger)

            case .isRunning:
                return try await ApplicationManagementTool.handleIsRunning(params, applicationService: applicationService, logger: logger)

            case .getRunningApplications:
                return try await ApplicationManagementTool.handleGetRunningApplications(applicationService: applicationService, logger: logger)

            case .activateApplication:
                return try await ApplicationManagementTool.handleActivateApplication(params, applicationService: applicationService, logger: logger)

            case .hideApplication:
                return try await ApplicationManagementTool.handleHideApplication(params, applicationService: applicationService, logger: logger)

            case .unhideApplication:
                return try await ApplicationManagementTool.handleUnhideApplication(params, applicationService: applicationService, logger: logger)

            case .hideOtherApplications:
                return try await ApplicationManagementTool.handleHideOtherApplications(params, applicationService: applicationService, logger: logger)

            case .getFrontmostApplication:
                return try await ApplicationManagementTool.handleGetFrontmostApplication(applicationService: applicationService, logger: logger)
            }
        }
    }
    ...
    private static func handleLaunch(
        ...
        logger.info("Handling launch action", metadata: [
    ...
    private static func handleTerminate(
        ...
        logger.info("Handling terminate action", metadata: [
            "params": "\(params.keys.joined(separator: ", "))"
        ])
        ...
        do {
            ...
            logger.error("Terminate failed", metadata: [
                "error": "\(error.localizedDescription)"
            ])
    ...
    private static func handleForceTerminate(
        ...
        logger.info("Handling force terminate action", metadata: [
            "params": "\(params.keys.joined(separator: ", "))"
        ])
        ...
        do {
            ...
            logger.error("Force terminate failed", metadata: [
                "error": "\(error.localizedDescription)"
            ])
            throw MCPError.internalError("Failed to force terminate application: \(error.localizedDescription)")
        }
    }
    ...
    private static func handleIsRunning(
        ...
        logger.info("Handling isRunning action", metadata: [
            "params": "\(params.keys.joined(separator: ", "))"
        ])
        ...
        do {
            ...
            logger.error("isRunning check failed", metadata: [
                "error": "\(error.localizedDescription)"
            ])
            throw MCPError.internalError("Failed to check if application is running: \(error.localizedDescription)")
        }
    }
    ...
    private static func handleGetRunningApplications(
        ...
        do {
            ...
            logger.error("getRunningApplications failed", metadata: [
                "error": "\(error.localizedDescription)"
            ])
            throw MCPError.internalError("Failed to get running applications: \(error.localizedDescription)")
        }
    }
    ...
    private static func handleActivateApplication(
        ...
        logger.info("Handling activateApplication action", metadata: [
            "params": "\(params.keys.joined(separator: ", "))"
        ])
        ...
        do {
            ...
            logger.error("activateApplication failed", metadata: [
                "error": "\(error.localizedDescription)"
            ])
    ...
    private static func handleHideApplication(
        ...
        logger.info("Handling hideApplication action", metadata: [
            "params": "\(params.keys.joined(separator: ", "))"
        ])
        ...
        do {
            ...
            logger.error("hideApplication failed", metadata: [
                "error": "\(error.localizedDescription)"
            ])
    ...
    private static func handleUnhideApplication(
        ...
        logger.info("Handling unhideApplication action", metadata: [
            "params": "\(params.keys.joined(separator: ", "))"
        ])
        ...
        do {
            ...
            logger.error("unhideApplication failed", metadata: [
                "error": "\(error.localizedDescription)"
            ])
    ...
    private static func handleHideOtherApplications(
        ...
        logger.info("Handling hideOtherApplications action", metadata: [
            "params": "\(params.keys.joined(separator: ", "))"
        ])
        ...
        do {
            ...
            // Format the result as JSON
            let exceptInfo = bundleIdentifier != nil ? """
                ,
                    "exceptBundleIdentifier": "\(bundleIdentifier!)"
                """ : ""
            ...
            logger.error("hideOtherApplications failed", metadata: [
                "error": "\(error.localizedDescription)"
            ])
            throw MCPError.internalError("Failed to hide other applications: \(error.localizedDescription)")
        }
    }
    ...
    private static func handleGetFrontmostApplication(
        ...
        do {
            ...
            logger.error("getFrontmostApplication failed", metadata: [
                "error": "\(error.localizedDescription)"
            ])
            throw MCPError.internalError("Failed to get frontmost application: \(error.localizedDescription)")
        }
    }
