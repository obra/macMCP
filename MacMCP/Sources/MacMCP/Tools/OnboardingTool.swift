// ABOUTME: This file defines the OnboardingTool for providing guidance to AI assistants.
// ABOUTME: It helps AI assistants understand how to effectively use macOS MCP for different application types.
...
public struct OnboardingTool: @unchecked Sendable {
    ...
    public let description = "Provides guidance and best practices for working with macOS applications"
    ...
    private func createInputSchema() -> Value {
        return .object([
            ...
            "properties": .object([
                "topic": .object([
                    "type": .string("string"),
                    "description": .string("The topic to get guidance for: general, exploration, interaction, keynote, pages, finder, safari, or complex_apps"),
                    "enum": .array([
                        .string("general"),
                        .string("exploration"),
                        .string("interaction"),
    ...
    private func getGuidance(topic: String, specific: String?) -> String {
        switch topic {
        case "general":
            return generalGuidance(specific: specific)
        case "exploration":
            return explorationGuidance(specific: specific)
        case "interaction":
            return interactionGuidance(specific: specific)
        case "keynote":
            return keynoteGuidance(specific: specific)
        case "pages":
            return pagesGuidance(specific: specific)
        case "finder":
            return finderGuidance(specific: specific)
        case "safari":
            return safariGuidance(specific: specific)
        case "complex_apps":
            return complexAppsGuidance(specific: specific)
        default:
            return "Topic not recognized. Please use one of the following: general, exploration, interaction, keynote, pages, finder, safari, or complex_apps."
        }
    }
    
    /// General guidance for working with macOS MCP
    private func generalGuidance(specific: String?) -> String {
        return """
    ...
    private func pagesGuidance(specific: String?) -> String {
        return """
        # Working with Pages
    ...
    private func finderGuidance(specific: String?) -> String {
        return """
        # Working with Finder
    ...
    private func safariGuidance(specific: String?) -> String {
        return """
        # Working with Safari
    ...
    private func complexAppsGuidance(specific: String?) -> String {
        return """
