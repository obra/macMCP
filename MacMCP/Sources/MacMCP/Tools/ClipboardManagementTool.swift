// ABOUTME: Implements clipboard management tool for reading and writing clipboard data
// ABOUTME: Provides JSON responses for clipboard operations with text, images, and files
...
public struct ClipboardManagementTool: @unchecked Sendable {
    ...
    public var description: String { "Manage clipboard content including text, images, and files" }
        ...
        return Value.object([
            ...
            "properties": .object([
                "action": .object([
                    ...
                    "description": .string("The clipboard action to perform")
                ]),
                "text": .object([
                    "type": .string("string"),
                    "description": .string("Text content to set in clipboard (for setText action)")
                ]),
                "imageData": .object([
                    "type": .string("string"),
                    "description": .string("Base64 encoded image data to set in clipboard (for setImage action)")
                ]),
                "filePaths": .object([
                    "type": .string("array"),
                    "items": .object([
                    ...
                    "description": .string("Array of file paths to set in clipboard (for setFiles action)")
                ])
            ]),
    ...
    public func execute(with input: [String: Any], env: [String: Any]) async throws -> [String: Any] {
