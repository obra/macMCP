// ABOUTME: This file extends ApplicationService with enhanced application management functionality.
// ABOUTME: It provides new methods for launching, terminating, and controlling applications.
...
extension ApplicationService {
    ...
    public func launchApplication(
        ...
        do {
            ...
            logger.error("Failed to launch application", metadata: [
                "bundleIdentifier": "\(appInfo.bundleIdentifier)",
                "name": "\(appInfo.name)",
    ...
    public func terminateApplication(
        ...
        logger.info("Terminating application", metadata: [
        ...
        if runningApps.isEmpty {
            logger.info("Application is not running", metadata: [
                "bundleIdentifier": "\(bundleIdentifier)"
            ])
        ...
        for app in runningApps {
            ...
            if !success {
                logger.warning("Failed to request termination for application instance", metadata: [
                    "bundleIdentifier": "\(bundleIdentifier)",
        ...
        if allTerminated {
            logger.debug("Waiting for application instances to terminate", metadata: [
                "bundleIdentifier": "\(bundleIdentifier)",
            ...
            let startTime = Date()
            var isTerminated = NSRunningApplication.runningApplications(withBundleIdentifier: bundleIdentifier).isEmpty
            ...
            while !isTerminated && Date().timeIntervalSince(startTime) < timeout {
                ...
                isTerminated = NSRunningApplication.runningApplications(withBundleIdentifier: bundleIdentifier).isEmpty
            }
            
            // If not terminated within timeout, update result
            if !isTerminated {
                logger.warning("Application did not terminate within timeout", metadata: [
                    "bundleIdentifier": "\(bundleIdentifier)",
                    "timeout": "\(timeout)"
                ])
                allTerminated = false
        ...
        if allTerminated {
            ...
            logger.info("Application terminated successfully", metadata: [
                "bundleIdentifier": "\(bundleIdentifier)"
            ])
        } else {
            logger.error("Failed to terminate all application instances", metadata: [
                "bundleIdentifier": "\(bundleIdentifier)"
            ])
        }
    ...
    public func forceTerminateApplication(
        ...
        logger.info("Force terminating application", metadata: [
            "bundleIdentifier": "\(bundleIdentifier)"
        ])
        ...
        for app in runningApps {
            ...
            if !success {
                logger.warning("Failed to force terminate application instance", metadata: [
                    "bundleIdentifier": "\(bundleIdentifier)",
                    "processId": "\(app.processIdentifier)"
                ])
                allTerminated = false
        ...
        let stillRunning = !NSRunningApplication.runningApplications(withBundleIdentifier: bundleIdentifier).isEmpty
        
        if stillRunning {
            logger.error("Some application instances are still running after force termination", metadata: [
                "bundleIdentifier": "\(bundleIdentifier)"
            ])
            allTerminated = false
        } else {
            ...
            logger.info("Application force terminated successfully", metadata: [
                "bundleIdentifier": "\(bundleIdentifier)"
            ])
        }
    ...
    public func hideApplication(
        ...
        logger.info("Hiding application", metadata: [
            "bundleIdentifier": "\(bundleIdentifier)"
        ])
        ...
        if runningApps.isEmpty {
            logger.warning("Application is not running", metadata: [
                "bundleIdentifier": "\(bundleIdentifier)"
            ])
        ...
        for app in runningApps {
            ...
            if !success {
                logger.warning("Failed to hide application instance", metadata: [
                    "bundleIdentifier": "\(bundleIdentifier)",
                    "processId": "\(app.processIdentifier)"
                ])
                allHidden = false
        ...
        if allHidden {
            logger.info("Application hidden successfully", metadata: [
                "bundleIdentifier": "\(bundleIdentifier)"
            ])
        } else {
            logger.error("Failed to hide all application instances", metadata: [
                "bundleIdentifier": "\(bundleIdentifier)"
            ])
        }
    ...
    public func unhideApplication(
        ...
        logger.info("Unhiding application", metadata: [
            "bundleIdentifier": "\(bundleIdentifier)"
        ])
        ...
        for app in runningApps {
            ...
            if !success {
                logger.warning("Failed to unhide application instance", metadata: [
                    "bundleIdentifier": "\(bundleIdentifier)",
                    "processId": "\(app.processIdentifier)"
                ])
                allUnhidden = false
        ...
        if allUnhidden {
            logger.info("Application unhidden successfully", metadata: [
                "bundleIdentifier": "\(bundleIdentifier)"
            ])
        } else {
            logger.error("Failed to unhide all application instances", metadata: [
                "bundleIdentifier": "\(bundleIdentifier)"
            ])
        }
    ...
    public func hideOtherApplications(
        ...
        logger.info("Hiding other applications", metadata: [
