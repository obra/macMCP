        ...
        do {
            ...
            if let menuTitle = menuTitle {
                ...
                let metadata = ResourcesRead.ResourceMetadata(
                    ...
                    additionalMetadata: [
                        "bundleId": .string(bundleId),
                        "menuCount": .double(Double(menus.count))
                    ]
                )
            ...
            logger.error("Failed to get application menus", metadata: [
                "bundleId": "\(bundleId)",
            ...
            if let navigationError = error as? MenuNavigationError {
                ...
                throw MCPError.internalError("Failed to get application menus: \(error.localizedDescription)")
            }
        }
    }
}