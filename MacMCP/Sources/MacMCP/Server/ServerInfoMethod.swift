// ABOUTME: This file defines the ServerInfo method for the MCP protocol.
// ABOUTME: It provides information about the server capabilities.
...
public enum ServerInfo: MCP.Method {
    ...
    public struct Result: Codable, Hashable, Sendable {
        ...
        public init(name: String, version: String, capabilities: Capabilities, info: ServerInfoDetails, supportedVersions: [String]) {
            self.name = name
