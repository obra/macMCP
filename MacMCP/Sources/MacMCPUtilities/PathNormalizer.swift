...
public class PathNormalizer {
  ...
  private static let attributePrefixes = ["AX"]
  ...
  private static let attributeNameMappings: [String: String] = [
    ...
    "identifier": "AXIdentifier", "help": "AXHelp", "role": "AXRole", "enabled": "AXEnabled",
    "focused": "AXFocused", "selected": "AXSelected", "parent": "AXParent",
    "children": "AXChildren",
    "position": "AXPosition", "size": "AXSize", "frame": "AXFrame", "bundleId": "bundleId",
    "bundleID": "bundleId",
  ]
  ...
  public static func normalizeAttributeName(_ name: String) -> String {
    ...
    if name == "bundleId" || name == "bundleId" || name == "bundleID" || name == "AXbundleId"
      || name == "AXbundleId" || name == "AXbundleID"
    {
      return "bundleId"
    }
    ...
    if let mappedName = attributeNameMappings[name] { return mappedName }
  ...
  public static func normalizePathString(_ path: String) -> String? {
    ...
    guard path.hasPrefix("macos://ui/") else { return nil }
  ...
  public static func generateNormalizedPath(for element: Any) -> String {
    ...
    if let roleChild = mirror.children.first(where: { $0.label == "role" }) {
      if let roleValue = roleChild.value as? String { role = roleValue }
    }
