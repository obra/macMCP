...
class KeyboardMonitor {
  ...
  func start() {
    ...
    print(
      String(
        format: "%8s | %5s | %-10s | %-8s | %-20s |", "Time", "Code", "Char", "Type", "Modifiers"))
    ...
    let logPath = FileManager.default.temporaryDirectory
      .appendingPathComponent("keyboard-monitor-\(dateString).log")
