// ABOUTME: MCPTreeVisualizer.swift
...
class MCPTreeVisualizer {
  ...
  func visualize(
    ...
    output += elementPrinter.formatElement(
      ...
      highlightPath: options.highlightPaths,
    )
  ...
  private func filterElements(_ elements: [MCPUIElementNode], withFilters: [String: String])
    -> [MCPUIElementNode]
  {
